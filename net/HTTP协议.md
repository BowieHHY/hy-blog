...
> 超文本传输协议（Hyper Text Transfer Protocol）是一个简单的请求-响应协议，通常运行在TCP之上，制定了客户端可能发送给服务器什么样的消息以及什么样的响应。

> HTTP 是应用层协议

HTTP 是基于客户/服务器模式，且面向连接的。

HTTP 连接是一种一次性连接，它限制每次连接只处理一个请求，及时释放连接可以提高服务器的执行效率。

HTTP 是一种无状态协议，即服务器不保留与客户交易时的任何状态，减轻了服务器记忆负担。
...
![img](http://localhost:5500/27-HTTP%20%E5%8F%8A%20TLS_files/1635260126b3a10c)
